...
소형 Radxa Zero 3W 4GB를 첫 실물 검증 후보로 변경했습니다. [실행 위치·배선·검증 조건](ONBOARD_COMPUTE.md)을 참고하세요. 실제 보드에서 전체 비전·보행·신경망을 동시에 시험하기 전에는 확정 부품이 아닙니다. 배터리, 보호 회로, 모터 전원, 로직 전원과 발열 설계도 남아 있습니다.
