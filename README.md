...
두 발 보행을 주 제품 요구사항으로 확정했고, 공용 부품을 이용한 Q4 네 발형을 추가했습니다. 웹에서 두 모델을 전환할 수 있습니다. Q4는 19개 부품 인스턴스의 STEP·GLB·출력 STL을 제공합니다. 현재는 고정 다리의 배치 시제품이며, 실제 보행 구동계는 미완성입니다.
